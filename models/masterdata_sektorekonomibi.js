...
class Masterdata_Sektorekonomibi extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_sektorekonomibi",
				modelName: "masterdata_sektorekonomibi",
			}
		);
	}
...
module.exports = Masterdata_Sektorekonomibi;
