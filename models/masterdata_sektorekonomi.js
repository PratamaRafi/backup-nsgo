...
class Masterdata_Sektorekonomi extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_sektorekonomi",
				modelName: "masterdata_sektorekonomi",
			}
		);
	}
...
module.exports = Masterdata_Sektorekonomi;
