...
class Masterdata_Golongandebitur extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_golongandebitur",
				modelName: "masterdata_golongandebitur",
			}
		);
	}
...
module.exports = Masterdata_Golongandebitur;
