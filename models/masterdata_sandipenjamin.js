...
class Masterdata_Sandipenjamin extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_sandipenjamin",
				modelName: "masterdata_sandipenjamin",
			}
		);
	}
...
module.exports = Masterdata_Sandipenjamin;
