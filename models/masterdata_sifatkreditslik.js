...
class Masterdata_Sifatkreditslik extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_sifatkreditslik",
				modelName: "masterdata_sifatkreditslik",
			}
		);
	}
...
module.exports = Masterdata_Sifatkreditslik;
