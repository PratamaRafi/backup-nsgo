...
class Masterdata_Sifatpinjaman extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_sifatpinjaman",
				modelName: "masterdata_sifatpinjaman",
			}
		);
	}
...
module.exports = Masterdata_Sifatpinjaman;
