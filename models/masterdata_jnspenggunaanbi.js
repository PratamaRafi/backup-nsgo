...
class Masterdata_Jnspenggunaanbi extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_jnspenggunaanbi",
				modelName: "masterdata_jnspenggunaanbi",
			}
		);
	}
...
module.exports = Masterdata_Jnspenggunaanbi;
