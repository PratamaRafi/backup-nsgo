...
class Masterdata_Bidangusahabi extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_bidangusahabi",
				modelName: "masterdata_bidangusahabi",
			}
		);
	}
...
module.exports = Masterdata_Bidangusahabi;
