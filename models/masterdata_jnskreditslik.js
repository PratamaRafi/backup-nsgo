...
class Masterdata_Jnskreditslik extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_jnskreditslik",
				modelName: "masterdata_jnskreditslik",
			}
		);
	}
...
module.exports = Masterdata_Jnskreditslik;
