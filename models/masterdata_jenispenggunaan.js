...
class Masterdata_Jenispenggunaan extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_jenispenggunaan",
				modelName: "masterdata_jenispenggunaan",
			}
		);
	}
...
module.exports = Masterdata_Jenispenggunaan;
