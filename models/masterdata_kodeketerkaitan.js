...
class Masterdata_Kodeketerkaitan extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_kodeketerkaitan",
				modelName: "masterdata_kodeketerkaitan",
			}
		);
	}
...
module.exports = Masterdata_Kodeketerkaitan;
