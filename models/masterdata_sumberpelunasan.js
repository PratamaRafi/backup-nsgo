...
class Masterdata_Sumberpelunasan extends BaseModel {
	static init(sequelize, Sequelize) {
		return super.init(
			...
			{ 
				...
				tableName: "masterdata_sumberpelunasan",
				modelName: "masterdata_sumberpelunasan",
			}
		);
	}
...
module.exports = Masterdata_Sumberpelunasan;
